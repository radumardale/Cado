...
async function seedBlogs() {
  try {
    ...
    console.log('Creating blog 1: Top 10 idei de cadouri corporate...');
    ...
    console.log('Creating blog 2: Ghid rapid pentru alegerea cadourilor...');
    await caller.blog.createBlog({
      data: {
        title: {
    ...
    console.log('Creating blog 3: De ce cadourile CADO nu sunt ca celelalte...');
    await caller.blog.createBlog({
      data: {
        title: {
    ...
    console.log('Creating blog 4: CADO: Povestea din spatele cadourilor...');
    await caller.blog.createBlog({
      data: {
        title: {
