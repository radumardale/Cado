...
/**
 * Example script for adding a product to the database.
 * This demonstrates the expected data structure for product creation.
 *
 * Usage: Modify the product data below and run:
 * npx tsx scripts/seed-products-example.ts
 */
