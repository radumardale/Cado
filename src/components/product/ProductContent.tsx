        ...
        <div className='col-span-5 pb-31 mt-16 sticky h-screen top-25 flex flex-col justify-between'>
            <div>
                ...
                <div className="grid grid-cols-5 gap-x-6 col-span-5">
                    ...
                    <button onClick={() => {addToCart(product, productQuantity, value, setValue, locale)}} className='h-12 col-span-3 bg-blue-2 text-white rounded-3xl font-manrope font-semibold cursor-pointer border hover:opacity-75 transition duration-300'>Adaugă în coș</button>
                </div>
            </div>
