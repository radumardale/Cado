...
export default function ImagesCarousel({
  ...
  const [prevImage, setPrevImage] = useState(
    initialActive - 1 < 0 ? product.images.length - 1 : initialActive - 1
  );
  ...
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1, transition: { duration: 0.2, ease: easeInOutCubic } }}
      exit={{ opacity: 0, transition: { duration: 0.2, ease: easeInOutCubic } }}
    ...
    >
      ...
      <div
        className='hidden gap-4 justify-center lg:flex'
        onMouseDown={e => {
          e.stopPropagation();
        }}
      >
