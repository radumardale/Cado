...
export default function SimiliarProducts({ category, productId }: SimiliarProductsInterface) {
  ...
  return (
    <>
      <h3
        className={
          'text-center lg:text-left lg:border-t lg:border-black text-2xl lg:text-[2rem] leading-7 lg:leading-9 lg:pt-6 mb-8 col-span-full font-manrope uppercase font-semibold'
        }
      >
        {t('similar_products')}
      </h3>
