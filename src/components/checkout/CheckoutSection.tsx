...
export default function CheckoutSection() {
  ...
  return (
    <div className="relative col-span-full grid grid-cols-8 lg:grid-cols-15 mt-16 gap-x-2 lg:gap-x-6">
      <CheckoutForm items={items} setDeliveryRegion={setDeliveryRegion} setDeliveryHour={setDeliveryHour}/>
      <CheckoutCart items={items} setValue={setValue} deliveryRegion={deliveryRegion} deliveryHour={deliveryHour}/>
    </div>
  )
}
