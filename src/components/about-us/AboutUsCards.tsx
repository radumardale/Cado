  ...
  return (
    <div className='col-span-full lg:col-start-2 lg:col-span-13 mb-24 lg:mb-42 z-10'>
        <div className="grid col-span-full grid-cols-8 lg:grid-cols-13 gap-x-6 gap-y-4 lg:gap-y-0 mb-6">
            ...
            <Image quality={100} priority src="/about-us/hero1.jpg" alt='hero image' width={580} height={600} className='col-span-full w-full lg:col-span-5 h-56 lg:h-full object-cover rounded-2xl lg:rounded-3xl order-1 lg:order-2' />
        </div>
        <div className="grid col-span-full grid-cols-13 gap-x-6 bg-blue-4 rounded-2xl lg:rounded-3xl pt-4 pb-6 lg:py-8 px-4 lg:px-0 lg:pl-8">
            <div className='col-span-full lg:col-span-6 h-full relative box-border'>
                <Image quality={100} priority src="/about-us/hero2.jpg" alt='hero image' width={913} height={536} className='h-full w-full object-cover rounded-2xl lg:rounded-3xl lg:absolute' />
            </div>
