  ...
  return (
    <div className='col-span-full lg:col-start-2 lg:col-span-13 mb-24 lg:mb-42 z-10'>
        <div className="grid col-span-full grid-cols-8 lg:grid-cols-13 gap-x-6 gap-y-4 lg:gap-y-0 mb-6">
            ...
            <Image unoptimized quality={100} priority src="/hero/hero1.jpg" alt='hero image' width={580} height={600} className='col-span-full lg:col-span-5 h-56 lg:h-full object-cover rounded-2xl lg:rounded-3xl order-1 lg:order-2' />
        </div>
