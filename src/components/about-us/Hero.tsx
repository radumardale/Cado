  ...
  return (
    <>
        <div className='absolute top-85 lg:top-48 z-0 w-full overflow-hidden'>
          <Image src="/ribbon/about-us-ribbon.png" alt="waving ribbon" width={1920} height={679} className='w-[calc(100%+20rem)] -translate-x-40 lg:translate-0 lg:w-full max-w-none' />
        </div>
