import { Html, Head, Preview, Font } from '@react-email/components';
                ...
                <tr>
                  <td align='center' style={{ padding: '0 20px' }}>
                    ...
                    >
                      ...
                      <br />
                      comanda{' '}
                      <span style={{ textDecoration: 'underline' }}>#{order?.custom_id}</span> a
                      fost preluată
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td align='center' style={{ padding: '0 20px 48px' }}>
                    <p style={{ textAlign: 'center', margin: '0' }}>
                      ...
                      cu confirmarea și factura comenzii.
                      <br />
                      <br />
                      Dacă nu ai primit e-mailul în două minute, te rugăm să verifici și folderul
                      spam.
                    </p>
                  </td>
                </tr>
                                  ...
                                  <td width='50%' valign='top' style={{ paddingRight: '12px' }}>
                                    ...
                                    >
                                      ...
                                      <tr>
                                        <td style={{ paddingBottom: '4px' }}>
                                          <p style={{ margin: '0' }}>
                                            {typeof order?.additional_info.delivery_address
                                              .region === 'string'
                              ...
                              >
                                ...
                                >
                                  ...
                                  <tr>
                                    <td style={{ paddingBottom: '4px' }}>
                                      <p style={{ margin: '0' }}>
                                        {typeof order?.additional_info.billing_address.region ===
                                        'string'
                                          ? order?.additional_info.billing_address.region.split(
                                              ' - '
                                            )[0]
                      ...
                      <tr>
                        <td>
                          <p style={{ margin: '0', lineHeight: '1.5' }}>
                            Dacă ai întrebări, te rugăm să ne{' '}
                            <a
                            ...
                            Pentru mai multe informații despre drepturile tale legale privind
                            anulările, te rugăm să consulți{' '}
                            <a
                              href={`${baseUrl}/terms`}
                              target='_blank'
                              style={{ color: '#ffffff' }}
                            ...
                            DIM EXPRES S.R.L.
                            <br />
                            Adresă juridică și poștală: mun. Chișinău, str. Alecu Russo, nr. 15, of.
                            59, Moldova
                            <br />
                            Cod fiscal: 1015600006586
                            <br />
                            <br />
                            <br />© 2025 CADO. Toate drepturile rezervate.
                          </p>
                        </td>
                      </tr>
                    </table>
