...
export default function Collaboration() {
  ...
  return (
    <>
        <h3 className='col-span-full text-center font-manrope text-2xl lg:text-3xl leading-7 lg:leading-11 uppercase font-semibold mb-8 lg:mb-6'>{ t("title") }</h3>
        <p className='col-span-full lg:col-start-6 lg:col-span-5 leading-4 lg:leading-5 text-sm lg:text-base text-center mb-4 lg:mb-12'>{ t("description") }</p>
        <div className='col-span-full grid grid-cols-15 gap-x-6 mb-42 gap-y-2 lg:gap-y-0'>
            <CollaborationCard index={1} title={t("card1.title")} description={t("card1.description")}/>
            <CollaborationCard index={2} title={t("card2.title")} description={t("card2.description")}/>
            <CollaborationCard index={3} title={t("card3.title")} description={t("card3.description")}/>
            <CollaborationCard index={4} title={t("card4.title")} description={t("card4.description")}/>
            <CollaborationCard index={5} title={t("card5.title")} description={t("card5.description")}/>
        </div>
    </>
  )
}
