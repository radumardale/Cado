...
export default function NewAdminBlogForm() {
  ...
  const {
    ...
    data: MutatedData,
    isPending,
  } = useMutation(trpc.blog.createBlog.mutationOptions());
  const { mutate: UpdateMutate, isSuccess: UpdateIsSuccess } = useMutation(
    trpc.image.uploadBlogImages.mutationOptions()
  );
              ...
              render={({ field }) => (
                <FormItem className='flex-1'>
                  ...
                  <Select
                    ...
                    value={isMounted ? field.value : BlogTags.NEWS}
                  >
                    <FormControl>
                    ...
                    render={({ field }) => (
                      <FormItem className='mb-4'>
                        ...
                        <FormControl>
                          <Textarea
                            data-lenis-prevent
                            className='scroll-bar-custom placeholder:text-black h-40 items-center px-6 border border-gray rounded-3xl text-base text-black pt-4 col-span-full'
