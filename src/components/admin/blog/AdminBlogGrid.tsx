    ...
    <div className='col-span-full xl:col-span-12 grid grid-cols-14 xl:grid-cols-12 gap-y-8 lg:gap-y-12 gap-x-6 mt-16 mb-24 lg:mb-42'>
      {isLoading || !data?.blogs ? (
        ...
        <>
          <Link
            href='/admin/blog/new'
            className='col-span-7 xl:col-span-6 aspect-[708/464] flex gap-2 items-center justify-center bg-[#F0F0F0] rounded-2xl border border-dashed border-gray cursor-pointer hover:opacity-75 transition duration-300 mb-4'
          >
