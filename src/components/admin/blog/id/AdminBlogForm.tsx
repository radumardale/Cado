...
export default function AdminBlogForm({ id }: AdminBlogFormProps) {
    ...
    const { mutate: UpdateMutate, isSuccess: UpdateIsSuccess, data: UpdateData } = useMutation(trpc.image.uploadBlogImages.mutationOptions());
    const { mutate: DeleteMutate, isSuccess: DeleteIsSuccess, isPending: DeleteIsPending } = useMutation(trpc.blog.deleteBlog.mutationOptions());
