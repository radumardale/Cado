  ...
  return (
    <>
      {isAddProductOpen && replaceProduct && (
        <div
          className='fixed top-0 left-0 w-full h-full bg-black/75 z-[60] flex justify-center items-center'
          onMouseDown={() => {
            setAddProductOpen(false);
          }}
        >
          <div
            className='py-16 px-34 rounded-3xl bg-white'
            onMouseDown={e => {
              e.stopPropagation();
            }}
          >
            <AdminRecommnendationsSearch
      ...
      <h2 className='col-span-full font-manrope font-semibold text-3xl leading-11 mb-12'>
        {t('recommendations')}
      </h2>
