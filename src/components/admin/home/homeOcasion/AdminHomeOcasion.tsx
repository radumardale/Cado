...
export default function AdminHomeOcasion() {
  ...
  const {
    ...
    isSuccess,
    data: MutatedData,
  } = useMutation(trpc.homeOcasion.updateHomeOcasion.mutationOptions());
  ...
  return (
    <>
      <h2 className='col-span-5 font-manrope font-semibold text-3xl leading-11 mb-10'>
        {t('soon_ocasion')}
      </h2>
                  ...
                  <Select onValueChange={field.onChange} value={field.value}>
                    ...
                    <SelectContent className='border-gray'>
                      <SelectGroup>
                        ...
                        <SelectItem className='text-base cursor-pointer' value={'DISCOUNTS'}>
                          {ocastionsT(`DISCOUNTS.title`)}
                        </SelectItem>
                      </SelectGroup>
                    </SelectContent>
                  </Select>
