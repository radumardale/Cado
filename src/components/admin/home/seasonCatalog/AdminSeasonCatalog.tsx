...
export default function AdminSeasonCatalog() {
    ...
    return (
      <>
          <h2 className='col-span-5 font-manrope font-semibold text-3xl leading-11 mb-10 mt-42 uppercase'>{t("season_catalog")}</h2>
          <h3 className='col-start-1 col-span-4 font-manrope font-semibold leading-7'>{t("season_catalog_details")}</h3>
          <Form {...form}>
                          ...
                          render={({ field }) => (
                              <>
                                  <FormItem className="text-black col-span-3">
                                      <FormLabel className="font-semibold font-manrope leading-5 whitespace-nowrap">{t("season_catalog")}</FormLabel>
                                      <FormMessage />
                      ...
                      <FormField
                          ...
                          render={({ field }) => (
                              <FormItem className="text-black col-span-6">
                                  <FormLabel className="font-semibold font-manrope leading-5">{t("season_catalog_link")}</FormLabel>
