...
const { data, isLoading } = trpc.order.getOrderById.useQuery({id: id});
    ...
    useEffect(() => {
      if (data?.order && !isLoading) {
        ...
        const isSameAddress = !data?.order.additional_info?.billing_address || 
        ...
        : {
            ...
            firstname: billingAddress?.firstname || data.order.additional_info?.user_data?.firstname || "",
            lastname: billingAddress?.lastname || data.order.additional_info?.user_data?.lastname || "",
            region: billingAddress?.region || "CHISINAU", 
            city: billingAddress?.city || "",
            home_address: billingAddress?.home_address || "",
            home_nr: billingAddress?.home_nr || ""
