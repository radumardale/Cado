    ...
    <>
        ...
        <div className='mt-16 col-span-7 flex gap-1 lg:gap-2 justify-end items-center'>
            <ControlsSortSelect setSortBy={setSortBy}>
              ...
              <SelectItem className="text-base cursor-pointer font-semibold font-manrope" value={SortBy.PRICE_ASC}>{t("orders_asc")}</SelectItem>
              <SelectItem className="text-base cursor-pointer font-semibold font-manrope" value={SortBy.PRICE_DESC}>{t("orders_desc")}</SelectItem>
            </ControlsSortSelect>
        </div>
    </>
  )
