...
export default function AdminProductImages({product}: AdminProductImagesProps) {
  ...
  return (
    <div data-lenis-prevent className='col-span-4 col-start-9 flex-1 overflow-y-auto mt-16 pb-8 pr-6 grid grid-cols-4 gap-x-6'>
        ...
        <div className='flex justify-end gap-6 flex-1 items-end mt-6 col-span-full'>
