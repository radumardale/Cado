...
export default function Controls({gridLayout, setGridLayout, setSortBy, setSidebarOpen, isSidebarOpen, searchText, countProducts}: ControlsProps) {
  ...
  return (
    <div className='col-span-full flex gap-1 lg:gap-2 justify-end sticky lg:relative top-14 lg:top-auto py-2 lg:py-0 left-0 z-40 bg-white lg:z-auto lg:bg-transparent items-center h-12'>
