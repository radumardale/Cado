...
export default function ProductCard({product}: ProductCardInterface) {
  ...
  return (
    <div className='col-span-3 group cursor-pointer'>
        <div className='relative overflow-hidden before:content-[""] before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-pureblack before:opacity-0 group-hover:before:opacity-50 before:rounded-2xl before:transition before:duration-300 before:z-10 mb-4'>
