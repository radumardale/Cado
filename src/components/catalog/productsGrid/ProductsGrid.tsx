...
export default function ProductsGrid({products, loading, setSortBy, category, setSidebarOpen, isSidebarOpen, searchText, countProducts}: ProductsGridProps) {
  ...
  return (
    <div className='col-span-full lg:col-start-4 lg:col-span-12 grid grid-cols-8 lg:grid-cols-12 mt-16 lg:mt-12 gap-x-2 lg:gap-y-6 lg:gap-6 h-fit min-h-screen grid-rows-[3rem_1fr]'>
