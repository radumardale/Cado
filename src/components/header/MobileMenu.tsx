    ...
    >
      ...
      >
        <Image
          ...
          height={56}
          alt='logo'
          className='h-8 w-fit mx-auto mb-4'
        />
      </Link>
      <Searchbar
        productsCount={0}
        ...
        <>
          <Accordion title={nav_t('catalog')} isMenuAccordion>
            <div className='flex flex-col gap-4 pb-2 pl-4'>
              <Link
                onClick={() => {
                  if (pathname === '/catalog') setSidebarOpen(false);
                }}
          ...
          <Link
            className='py-4 border-b border-lightgray'
            href='/'
            onClick={() => {
              if (pathname === '/') setSidebarOpen(false);
            }}
          ...
          <Link
            ...
            href='/about-us'
            onClick={() => {
              if (pathname === '/about-us') setSidebarOpen(false);
            }}
          >
          ...
          <Link
            ...
            href='/blogs'
            onClick={() => {
              if (pathname === '/blogs') setSidebarOpen(false);
            }}
          >
          ...
          <Link
            ...
            href='/contacts'
            onClick={() => {
              if (pathname === '/contacts') setSidebarOpen(false);
            }}
          >
