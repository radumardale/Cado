...
export default function CatalogMenu({setIsCatalogMenuActive}: CatalogMenuProps) {
  return (
    <div className='hidden lg:grid col-start-1 col-span-full lg:grid-cols-13 2xl:grid-cols-full gap-x-6 pt-4 pb-6 relative z-50' onMouseEnter={() => {setIsCatalogMenuActive(true)}} onMouseLeave={() => {setIsCatalogMenuActive(false)}}>
