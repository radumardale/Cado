  ...
  return (
    <div className='flex justify-center col-span-full'>
      <Link href={href} className={`col-span-full w-fit ${className}`}>
        ...
        >
          <span className='whitespace-nowrap ml-6 mr-12 lg:group-hover:opacity-100 transition duration-400 lg:opacity-0'>
            {text}
          </span>
          <ArrowRight
            className={`size-6 absolute z-20 right-3 top-1/2 -translate-y-1/2 transition duration-300 -rotate-45 ${isButtonActive ? 'lg:rotate-0' : 'lg:-rotate-45 lg:delay-200'}`}
          />
        </button>
      </Link>
    </div>
