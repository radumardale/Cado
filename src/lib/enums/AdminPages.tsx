...
export const AdminPagesArr = Object.values(AdminPages).filter(
...
export const AdminPagesIcons: Record<AdminPages, ReactNode> = {
  ...
  [AdminPages.HOME_PAGE]: (
    <StickyNote strokeWidth={1.5} className='size-6 transition duration-300' />
  ),
  [AdminPages.BLOG_PAGE]: (
    <StickyNote strokeWidth={1.5} className='size-6 transition duration-300' />
  ),
};
