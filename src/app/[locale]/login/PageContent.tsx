      ...
      {displayAdmin ? (
          ...
          <div className='col-start-6 col-span-5 justify-center z-10 h-screen grid grid-cols-5'>
            <div className='col-span-full bg-white h-fit grid grid-cols-5 my-auto py-12 rounded-3xl'>
              <form
                ...
                className='z-50 h-fit bg-white col-start-2 col-span-3'
              >
                <Image
                ...
                />
                <Input
                  className='mt-8 mb-4 h-12 w-full px-6 rounded-3xl text-base text-black border-gray shadow-none placeholder:text-black'
                ...
                <div className='w-full relative'>
                  ...
                  <Input
                    ...
                    className='mb-8 h-12 w-full pl-6 pr-14 rounded-3xl text-base text-black border-gray shadow-none placeholder:text-black'
                ...
                <button className='w-full text-center bg-black h-12 text-white rounded-3xl font-manrope font-semibold cursor-pointer hover:opacity-75 transition duration-300'>
                  {t('login')}
                </button>
              </form>
            </div>
        ...
        <div className='fixed inset-0 flex items-center justify-center bg-darkblue px-4'>
          <div className='bg-white rounded-[1rem] max-w-2xl w-full p-[3rem] flex flex-col items-center justify-center'>
            ...
            />
            <p className='text-base font-roboto font-[400] text-darkblue mt-[1rem] text-center'>
              {admin_t('unsupported_device')}
            </p>
            <p className='text-base font-roboto font-[400] text-darkblue mt-[1rem] text-center'>
              {admin_t('unsupported_device_message')}
            </p>
          </div>
        </div>
      )}
