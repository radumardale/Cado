          ...
          <div className='col-span-full lg:col-start-4 2xl:col-start-4 lg:col-span-10 2xl:col-span-12 grid grid-cols-8 lg:grid-cols-12 mt-16 lg:mt-12 gap-x-2 lg:gap-y-6 lg:gap-6 h-fit'>
            <div className='col-span-full flex gap-1 lg:gap-2 justify-end sticky lg:relative top-14 lg:top-auto py-2 lg:py-0 left-0 z-40 bg-white lg:z-auto lg:bg-transparent items-center'>
              <div className='flex gap-1 lg:gap-2 w-full lg:w-auto'>
                <button
                  className={`lg:hidden mr-auto size-12 rounded-full border border-black flex justify-center items-center transition duration-300 hover:bg-black cursor-pointer hover:text-white`}
                >
                ...
                <button
                  className={`size-12 rounded-full border border-black flex justify-center items-center transition duration-300 hover:bg-black cursor-pointer hover:text-white bg-black text-white`}
                >
                  <LayoutGrid className='size-5' strokeWidth={1.75} />
                </button>
                <button
                  className={`size-12 rounded-full border border-black flex justify-center items-center transition duration-300 hover:bg-black cursor-pointer hover:text-white`}
                >
