...
export function PageContent({ id }: Props) {
  ...
  return (
    <div className='col-span-full flex h-[calc(100vh-8rem)] w-full flex-col items-center justify-center'>
      ...
      <h1 className='font-manrope text-[1.5rem] font-bold uppercase leading-[1.75rem] text-center text-darkblue mt-[1.5rem]'>
        {t('title_slice_1')}
        <br />
        {t('title_slice_2')}
      </h1>
      <p className='text-base leading-4.5 font-roboto font-[400] text-center text-darkblue mt-[2.5rem]'>
        {t('subtitle_slice_1')}
        <br />
        {t('subtitle_slice_2')}{' '}
